...
public class DamageblockComponent extends ItemMDisableWorldListComponent {
   @NotNull
   ...
   public DamageblockComponent(@NotNull ConfigurationSection config) {
      super(config);
      this.config = config;
      this.toPlaceBlockM = new BlockM(this.config.getConfigurationSection("to_place_blockm"));
