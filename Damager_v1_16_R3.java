...
public class Damager_v1_16_R3 extends Damager {
   @NotNull
   private final DamageSource damageSource;

   public Damager_v1_16_R3(@NotNull World world, @NotNull UUID uniquePlayerUuid, @NotNull String uniquePlayerName) {
   ...
   protected void runTemporaryDisableAnnounceAdvancementsRunnable(@NotNull Runnable disableAnnounceAdvancementsRunnable) {
      ...
      boolean savedValue = Boolean.parseBoolean(String.valueOf(world.getGameRuleValue(GameRule.ANNOUNCE_ADVANCEMENTS)));
      world.setGameRule(GameRule.ANNOUNCE_ADVANCEMENTS, false);
      disableAnnounceAdvancementsRunnable.run();
      world.setGameRule(GameRule.ANNOUNCE_ADVANCEMENTS, savedValue);
   }
}
